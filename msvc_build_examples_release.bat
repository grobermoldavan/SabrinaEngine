...
set buildFolderDir=%cd%\builds\examples_win32_release\
...
:build
    ...
    call engine_builder\win_builder "%projectName%" "%sourceFolderDir%" "%buildFolderDir%" "%engineInclude%" msvc release
Goto :Eof
