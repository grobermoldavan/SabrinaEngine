...
VkPipelineShaderStageCreateInfo se_vk_program_get_shader_stage_create_info(struct SeVkDevice* device, SeVkProgramWithConstants* pipelineProgram, AllocatorBindings& allocator);
