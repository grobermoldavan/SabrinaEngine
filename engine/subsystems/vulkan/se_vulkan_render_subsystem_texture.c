...
void se_vk_texture_construct(SeVkTexture* texture, SeVkTextureInfo* info)
{
    ...
    VkDevice logicalHandle = se_vk_device_get_logical_handle(info->device);
    {
        ...
        *texture = (SeVkTexture)
        {
            .object                 = (SeVkObject){ SE_VK_TYPE_TEXTURE, g_textureIndex++ },
            .device                 = info->device,
            .extent                 = info->extent,
            .format                 = info->format,
            ...
            .memory                 = {0},
            .view                   = VK_NULL_HANDLE,
            .fullSubresourceRange   = (VkImageSubresourceRange){ aspect, 0, VK_REMAINING_MIP_LEVELS, 0, VK_REMAINING_ARRAY_LAYERS },
            .flags                  = 0,
        };
    }
    {
    ...
    *texture = (SeVkTexture)
    {
        ...
        .memory                 = {0},
        .view                   = view,
        .fullSubresourceRange   = (VkImageSubresourceRange){ VK_IMAGE_ASPECT_COLOR_BIT, 0, VK_REMAINING_MIP_LEVELS, 0, VK_REMAINING_ARRAY_LAYERS },
