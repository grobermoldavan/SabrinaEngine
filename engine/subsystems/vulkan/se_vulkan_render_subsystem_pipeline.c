...
void se_vk_pipeline_graphics_construct(SeVkPipeline* pipeline, SeVkGraphicsPipelineInfo* info)
{
    ...
    *pipeline = (SeVkPipeline)
    {
        .object                     = (SeVkObject){ SE_VK_TYPE_GRAPHICS_PIPELINE, g_pipelineIndex++ },
        .device                     = device,
    ...
    //         clear values.
    //
    const VkPipelineDepthStencilStateCreateInfo depthStencilState = (VkPipelineDepthStencilStateCreateInfo)
    {
