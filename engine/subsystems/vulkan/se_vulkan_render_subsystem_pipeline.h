...
typedef struct SeVkGraphicsPipelineInfo
{
    struct SeVkDevice*          device;
    struct SeVkRenderPass*      pass;
...
} SeVkGraphicsPipelineInfo;

typedef struct SeVkComputePipelineInfo
{
    struct SeVkDevice*          device;
    SeVkProgramWithConstants    program;
} SeVkComputePipelineInfo;
